...
mpiexec -f ../../MPI_implementation/machines -n 1 ../../MPI_implementation/game_of_life -d 30 -l 100;
echo
echo "Execution 2"
echo "Processors: 1, Dimension: 300x300, Loops: 100"
mpiexec -f ../../MPI_implementation/machines -n 1 ../../MPI_implementation/game_of_life -d 300 -l 100;
echo
echo "Execution 3"
echo "Processors: 1, Dimension: 3000x3000, Loops: 100"
mpiexec -f ../../MPI_implementation/machines -n 1 ../../MPI_implementation/game_of_life -d 3000 -l 100;
echo
########################################################################################################
echo "Execution 4"
