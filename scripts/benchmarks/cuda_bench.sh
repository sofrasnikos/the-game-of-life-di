...
../../CUDA_implementation/game_of_life -d 30 -l 1000;
echo
echo "Execution 3"
echo "Processors: 4, DimeFnsion: 300x300, Loops: 100"
../../CUDA_implementation/game_of_life -d 300 -l 100;
echo
echo "Execution 4"
echo "Processors: 4, Dimension: 300x300, Loops: 1000"
../../CUDA_implementation/game_of_life -d 300 -l 1000;
echo
echo "Execution 5"
...
../../CUDA_implementation/game_of_life -d 3000 -l 1000;
echo
echo "Execution 7"
